...
LDFLAGS += -X "$(PD_PKG)/server/versioninfo.PDReleaseVersion=v6.2.0-serverless"
...
ifneq ($(DASHBOARD), 0)
	...
	LDFLAGS += -X "github.com/pingcap/tidb-dashboard/pkg/utils/version.PDVersion=v6.2.0-serverless"
